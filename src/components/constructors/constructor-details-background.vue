  ...
  >
    <defs>
      <clipPath id="a" transform="translate(-266.62 -17.66)">
        <path
          class="fill-none"
          d="M1173.38,305.56l174.7,337.94H401.91l104-264.15Z"
        />
      </clipPath>
    </defs>
    <path
    ...
    <rect
      ...
      width="242.51"
      height="341.29"
      transform="translate(-30 1375) rotate(-71.44)"
    />
    <g class="e">
      <rect
        class="fill-white"
      ...
      <rect
        ...
        width="289.77"
        height="5.93"
        transform="translate(-302.73 1068.58) rotate(-47.01)"
      />
    </g>
  </svg>
</template>
...
<script>
export default {
  name: "constructor-details-background",
  props: {
    primary: {
      type: String,
      default: "#ffc100",
